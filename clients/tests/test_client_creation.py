...
class TestClientCreation(APITestCase):
    """
    ...
    def test_client_is_created(self):
        ...
        self.assertTrue(models.Client.objects.filter(
            name=self.data['name'], doctor=self.user).exists())
        # TODO: update tests to ensure they are enrolled to programs
        # once program enrollment is setup
